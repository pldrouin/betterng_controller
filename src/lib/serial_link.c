...
struct cmd_info cmd_info[] = {
  ...
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID 206
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 207
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 208
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID 209
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_SENSOR_VALUE_CMD_RESP_ID 210
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_SENSOR_VALUE_CMD_RESP_ID 211
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_SENSOR_VALUE_CMD_RESP_ID 212
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_LM75A_TEMP_SENSOR_CALIB_CMD_RESP_ID 213
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_ANALOG_TEMP_SENSOR_CALIB_CMD_RESP_ID 214
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 215
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 216
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 217
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 218
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 219
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 220
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 221
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 222
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 223
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 224
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 225
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_LIST_CMD_RESP_ID 226
  ...
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID 233
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID 234
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_SOFT_TEMP_SENSOR_LIST_CMD_RESP_ID 235
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 236
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 237
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_N_CURVE_POINTS_CMD_RESP_ID 238
  {CMD_TIMEOUT(DEFAULT), 3, NULL}, // GET_FAN_CURVE_POINT_CMD_RESP_ID 239
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_FAN_TACH_TICKS_CMD_RESP 242
