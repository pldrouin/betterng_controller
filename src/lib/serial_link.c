...
struct cmd_info cmd_info[] = {
  ...
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID 200
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 201
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 202
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID 203
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_SENSOR_VALUE_CMD_RESP_ID 204
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_SENSOR_VALUE_CMD_RESP_ID 205
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_SENSOR_VALUE_CMD_RESP_ID 206
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_LM75A_TEMP_SENSOR_CALIB_CMD_RESP_ID 207
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_ANALOG_TEMP_SENSOR_CALIB0_CMD_RESP_ID 208
