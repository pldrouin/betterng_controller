...
struct cmd_info cmd_info[] = {
  ...
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID 199
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 200
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 201
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID 202
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_TEMP_SENSOR_ADC_VALUE_CMD_RESP_ID 203
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_TEMP_SENSOR_VALUE_CMD_RESP_ID 204
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_TEMP_SENSOR_VALUE_CMD_RESP_ID 205
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_TEMP_SENSOR_VALUE_CMD_RESP_ID 206
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_LM75A_TEMP_SENSOR_CALIB_CMD_RESP_ID 207
  {CMD_TIMEOUT(DEFAULT), 9, NULL}, // GET_ANALOG_TEMP_SENSOR_CALIB0_CMD_RESP_ID 208
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_ANALOG_TEMP_SENSOR_CALIB1_CMD_RESP_ID 209
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 210
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 211
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 212
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 213
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 214
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 215
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 216
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 217
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 218
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 219
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 220
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 221
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_LIST_CMD_RESP_ID 222
  ...
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 228
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID 229
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID 230
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_SOFT_TEMP_SENSOR_LIST_CMD_RESP_ID 231
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 232
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 233
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_N_CURVE_POINTS_CMD_RESP_ID 234
  {CMD_TIMEOUT(DEFAULT), 3, NULL}, // GET_FAN_CURVE_POINT_CMD_RESP_ID 235
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_FAN_MIN_TACH_TICKS_CMD_RESP 236
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, //239
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_FAN_MAX_TACH_TICKS_CMD_RESP 238
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, //239
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_FAN_TACH_TICKS_CMD_RESP 240
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_FAN_HYSTERISIS_CMD_RESP_ID 241
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, //242
