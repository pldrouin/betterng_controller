...
struct cmd_info cmd_info[] = {
  ...
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_LM75A_TEMP_SENSOR_LIST_CMD_RESP_ID 208
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 209
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 210
  {CMD_TIMEOUT(DEFAULT), 1, NULL}, // GET_ANALOG_TEMP_SENSOR_LIST_CMD_RESP_ID 211
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_SENSOR_VALUE_CMD_RESP_ID 212
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_SENSOR_VALUE_CMD_RESP_ID 213
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_SENSOR_VALUE_CMD_RESP_ID 214
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_LM75A_TEMP_SENSOR_CALIB_CMD_RESP_ID 215
  {CMD_TIMEOUT(DEFAULT), 7, NULL}, // GET_ANALOG_TEMP_SENSOR_CALIB_CMD_RESP_ID 216
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 217
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 218
  {CMD_TIMEOUT(DEFAULT), 0, NULL}, // 219
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_LM75A_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 220
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_ANALOG_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 221
  {CMD_TIMEOUT(DEFAULT), 2, NULL}, // GET_SOFT_TEMP_SENSOR_ALARM_VALUE_CMD_RESP_ID 222
